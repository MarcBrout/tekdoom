...
** Last update Wed Jan 27 06:53:26 2016 maud marel
*/
...
void	draw_sulf(t_param *arg)
{
  ...
  if (arg->inter.gun.check_sul > 30 && arg->inter.gun.check_sul <= 36)
    draw_shoot(arg, arg->inter.gun.sulf1);
